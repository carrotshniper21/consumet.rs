...
pub trait MangaParser: BaseParser {
    /// Returns a future which resolves into an manga info object (including the chapters). (*[`impl Future<Output = Result<IMangaInfo>>`](https://github.com/carrotshniper21/consumet-api-rs/blob/main/src/models/types.rs#L260-L268)*)\
    /// # Parameters
    ...
    /// Returns a future which resolves into an vector of pages. (*[`impl Future<Output = Result<Vec<IMangaChapterPage>>>`](https://github.com/carrotshniper21/consumet-api-rs/blob/main/src/models/types.rs#L270-L273)*)\
    /// # Parameters
